...
if("TRUE" STREQUAL "TRUE")
  set(ball_detector_SOURCE_PREFIX /media/psf/Home/Documents/GitHub/fanboat/src/lab3/ball_detector)
  set(ball_detector_DEVEL_PREFIX /media/psf/Home/Documents/GitHub/fanboat/devel)
  ...
  set(ball_detector_INSTALL_PREFIX /media/psf/Home/Documents/GitHub/fanboat/install)
...
if(NOT "/media/psf/Home/Documents/GitHub/fanboat/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/Home/Documents/GitHub/fanboat/src/lab3/ball_detector/${idir}'.  Ask the maintainer 'indigo <indigo@todo.todo>' to fix it.")
    endif()
